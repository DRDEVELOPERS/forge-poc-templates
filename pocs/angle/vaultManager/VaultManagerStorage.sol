...
contract VaultManagerStorage is
    ...
    ReentrancyGuardUpgradeable
{
    ...
    event LiquidationBoostParametersUpdated(
        address indexed _veBoostProxy,
        uint256[] xBoost,
        uint256[] yBoost
    );
